...
public class Edge {
    ...
    public Edge(long a_id, int a_aId, int a_bId, int a_mode, int a_distance)
    {
        ...
        if(m_mode == competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_JUMP_BIG ||
           m_mode == competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_JUMP_SMALL ||
           m_mode >= competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_FAITH_JUMP
           )
        {
            m_cost = (int) (a_distance * 1.5f); //2
        }else if(m_mode == competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_BREAKABLE)
        {
