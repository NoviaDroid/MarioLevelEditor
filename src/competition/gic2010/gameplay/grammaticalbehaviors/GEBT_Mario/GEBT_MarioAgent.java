package competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario;

import java.util.Hashtable;
import java.util.LinkedList;
import java.util.Vector;

import competition.gic2010.gameplay.grammaticalbehaviors.bt.behaviortree.BTStream;
import competition.gic2010.gameplay.grammaticalbehaviors.bt.behaviortree.BehaviorTree;
...
public class GEBT_MarioAgent implements Agent
{
    ...
    public static final int MARIO_X = 10;// Environment.HalfObsHeight; //10;
    public static final int MARIO_Y = 10;//Environment.HalfObsWidth;  //10;
...
//        }
    ...
    public boolean increaseGraphLength()
    {
        ...
        if(m_graphLenghtMultiplier>3)
        {
            m_graphLenghtMultiplier = 3;
            return false;
        }
        return true;
    }
    ...
    public void scanLevel()
    {
        if(m_MarioXInMapChunk == 1)
        {
          ...
          //  System.out.println("###########################");
          int from = m_MarioXInMap - 15*m_graphLenghtMultiplier;
          int to = m_MarioXInMap + 15;
          if(to < m_maxGraphTo)
            to = m_maxGraphTo;
