...
public class Map {
    ...
    public static final int MAP_COIN_ANIM = GeneralizerLevelScene.COIN_ANIM;
    ...
    private boolean checkJump(int a_ax, int a_ay ,int a_bx, int a_by)
    {
        ...
        int heightCheck = 2; //at least this must be 2. Greater if more restristive for jumps
        ...
        {
            obstacle = checkObstacle(a_ax, a_ay+1, a_bx,  a_ay+1+heightCheck);
            if(!obstacle)
