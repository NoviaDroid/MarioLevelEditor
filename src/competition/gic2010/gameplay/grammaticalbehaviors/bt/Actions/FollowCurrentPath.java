...
import competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Edge;
...
public class FollowCurrentPath extends BTLeafNode{
    ...
    public void step() throws IncorrectNodeException 
    {
        ...
        else
        {
            ...
            int futureLinkType1 = competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_UNDEF;
            ...
            int futureLinkType2 = competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_UNDEF;
            ...
            else
            {
                ...
                if(m_currentLinkType == competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_BREAKABLE)
                {
                ...
                switch(link.getMode())
                {
                    ...
                    case competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_WALK_SMALL:
                    ...
                    case competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_WALK_BIG:
                        ...
                        if( /*futureLinkType2 == Graph.MODE_UNDEF ||*/
                            futureLinkType2 == competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_JUMP_BIG || futureLinkType2 == competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_JUMP_SMALL ||
                            futureLinkType2 >= competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_FAITH_JUMP || futureLinkType2 == competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_BREAKABLE)
                        {

                            Node dest = mario.getMap().getGraph().getNode(futureNodeIdDest);
                            if(dest != null)
                            {
                                if(futureLink.getMode() >= competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_FAITH_JUMP &&
                                    futureLink.getMetadata() != Edge.META_HOLE)
                                    checkJump = false;

                                if((futureLink.getMode() == competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_JUMP_BIG ||
                                    futureLink.getMode() == competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_JUMP_SMALL) &&
                        ...
                        if( /*futureLinkType1 == Graph.MODE_UNDEF || */
                            futureLinkType1 == competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_JUMP_BIG || futureLinkType1 == competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_JUMP_SMALL ||
                            futureLinkType1 >= competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_FAITH_JUMP || futureLinkType1 == competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_BREAKABLE)
                        {
                            checkJump = true;
                            Node dest = mario.getMap().getGraph().getNode(nextNodeIdDest);
                            if(dest != null)
                            {
                                if(nextLink.getMode() >= competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_FAITH_JUMP &&
                                    nextLink.getMetadata() != Edge.META_HOLE)
                                    checkJump = false;

                                if((nextLink.getMode() == competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_JUMP_BIG ||
                                    nextLink.getMode() == competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_JUMP_SMALL) &&
                    ...
                    case competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_JUMP_SMALL:
                        if(mario.isMarioLarge())
                        {
                            //Mario large, but edge for small mario.
                            //THIS COLUD HAPPEN IF MARIO EATS A MUSHROOM WHILE
                    ...
                    case competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_JUMP_BIG:
                    ...
                    case competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_FALL_SMALL:
                        if(mario.isMarioLarge())
                        {
                            //Mario large, but edge for small mario.
                            //THIS COLUD HAPPEN IF MARIO EATS A MUSHROOM WHILE
                    ...
                    case competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_FALL_BIG:
                    ...
                    case competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_BREAKABLE:
                    ...
                    default:
                        ...
                        if(link.getMode() >= competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_FAITH_JUMP &&
                           link.getMode() < competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_FAITH_JUMP*2)
                        {
                        ...
                        }else if(link.getMode() >= competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_FAITH_JUMP*2) faithJumpOk = true;
                                ...
                                Node a_destNode, Edge a_edge)
    {
        ...
        else if(!m_readyToJump)
        {
            ...
            else if (mario.isMarioOnPos(a_marioNode.getX()))
            {
                ...
                if( a_edge.getMode() >= competition.gic2010.gameplay.grammaticalbehaviors.GEBT_Mario.Graph.MODE_FAITH_JUMP &&
                    a_edge.getMetadata() != Edge.META_HOLE &&
                    m_jumpDestHolesMode != 0)
                     checkSpeed = false;
                
                if(checkSpeed && Math.abs(marioSpeedX) < 0.25) //0.1
                {
        ...
        else
        {
            ...
            manageLeftRightInertia(mario, marioInertia, a_edge);
    ...
    private void manageLeftRightInertia(GEBT_MarioAgent mario, float a_xSpeed, Edge a_edge)
    {
        ...
        {
            //JUMPING TO THE RIGHT!
            if(a_xSpeed > maxRightSpeed)
            {
                //But I am going further, lets correct that
                mario.setAction(Mario.KEY_LEFT,true);
            }else if(a_xSpeed <= 1 && jumpOverHole)
            {
                mario.setAction(Mario.KEY_RIGHT,true);
            }
        }
    ...
    private boolean manageFall(GEBT_MarioAgent mario, Node a_marioNode, Node a_destNode)
    {
        ...
        {
            int marioInertia = mario.getInertia();
            manageLeftRightInertia(mario, marioInertia, null);
