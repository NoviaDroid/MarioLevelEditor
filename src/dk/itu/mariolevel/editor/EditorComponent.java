...
public class EditorComponent extends JPanel {
	...
	private void addTileGroups() {
		...
		addTileGroup(new TileGroup("enemies", new byte[]{Level.SPECIAL_BLOCK_GOOMBA,Level.SPECIAL_BLOCK_RED_KOOPA,Level.SPECIAL_BLOCK_GREEN_KOOPA,Level.SPECIAL_BLOCK_FLOWER,0}, width, this));
